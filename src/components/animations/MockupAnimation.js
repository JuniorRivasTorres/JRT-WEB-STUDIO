...
const Wrapper = styled.div `
  ...
  .mockup3 {
    ...
    background:  url("/images/animations/mockup-content.svg"), rgba(23, 12, 61, 0.5);
  ...
  .mockup4 {
    ...
    background: url("/images/animations/mockupNOIR.svg"), rgba(39, 20, 62, 0.3);
  ...
  .mockup5 {
    ...
    background:  url("/images/animations/mockup3-bg.svg"), rgba(39, 20, 62, 0.2);
    border: 0.5px solid rgba(255, 255, 255, 0.2);
    box-sizing: border-box;
    backdrop-filter: blur(27.3844px);
    /* Note: backdrop-filter has minimal browser support */
